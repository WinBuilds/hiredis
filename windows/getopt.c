...
{
  return getopt_internal (argc, argv, (char*)shortopts, (struct option*)longopts, longind, 0);
}
...
getopt_long_only (int argc, char **argv, const char *shortopts,
                  const struct option * longopts, int *longind)
{
  return getopt_internal (argc, argv, (char*)shortopts, (struct option*)longopts, longind, 1);
}
